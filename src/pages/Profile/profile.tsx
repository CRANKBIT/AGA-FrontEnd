        ...
        <div className="text-xl">
          <div className="container mx-auto p-4">
            ...
            <div className="flex mt-8">
              <button className="px-4 py-2 bg-indigo-500 text-white font-semibold rounded hover:bg-indigo-700">
                Update Changes
              </button>
            </div>
            <hr/>
            ...
            <div className="flex mt-4">
              <button className="px-4 py-2 bg-indigo-500 text-white font-semibold rounded hover:bg-red-700">
                Logout
              </button>
            </div>
            <div className=" container mx-auto p-4">
