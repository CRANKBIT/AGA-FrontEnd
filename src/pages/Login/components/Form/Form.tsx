...
const Form: FC = () => (
  <div className="py-80">
    <div className="flex justify-center items-center bg-white w-[640px]">
      <div className="relative text-left w-[280px] h-[356px]">
        ...
        <div>
          <div>
            ...
            <input
              className="box-border pl-[3px] w-[280px] h-11 mb-6 border border-[#03111B] rounded-[5px] placeholder-shown:border-gray-500"
